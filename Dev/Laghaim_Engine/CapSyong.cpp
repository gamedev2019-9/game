...
int CLolosBase::Read( PFILE *fp, BOOL bAlpha, BOOL bLoadWalkPlane )
{
	int i;
...
int CLolosBase::Read( char* szFileName, BOOL bAlpha, BOOL bLoadWalkPlane )
{
	...
	all_face_count = Read( fp, bAlpha, bLoadWalkPlane );
	pfclose( fp );
