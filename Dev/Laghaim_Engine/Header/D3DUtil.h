...
//-----------------------------------------------------------------------------
// Additional Nako Vector support
//-----------------------------------------------------------------------------
inline void Nk3DUtil_VectorMake(D3DVECTOR &v, D3DVERTEX v1, D3DVERTEX v2)
{
	v.x = v1.x - v2.x;
	v.y = v1.y - v2.y;
	v.z = v1.z - v2.z;
...
inline void Nk3DUtil_VectorMake(D3DVECTOR &v, D3DVECTOR v1, D3DVECTOR v2)
{
	v.x = v1.x - v2.x;
	v.y = v1.y - v2.y;
	v.z = v1.z - v2.z;
